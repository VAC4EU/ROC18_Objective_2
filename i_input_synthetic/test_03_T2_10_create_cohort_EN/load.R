...
listdatasetsRData <- c("Sk_PANNICULITIS_AESI_narrow", "D3_all_vaccines_curated", "SK_ERYTHEMANODOSUM_AESI_narrow")
...
listdates[["Sk_PANNICULITIS_AESI_narrow"]] <- c("date")
listdates[["SK_ERYTHEMANODOSUM_AESI_narrow"]] <- c("date")
