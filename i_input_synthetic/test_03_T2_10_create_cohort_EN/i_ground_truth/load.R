...
listdatasets <- c("D3_cohort_SK_ERYTHEMANODOSUM_AESI")
...
listdates[["D3_cohort_SK_ERYTHEMANODOSUM_AESI"]] <- c("cohort_entry_date_SK_ERYTHEMANODOSUM_AESI", "study_entry_date",	"study_exit_date", "start_follow_up_SK_ERYTHEMANODOSUM_AESI","start_follow_up_SK_ERYTHEMANODOSUM_AESI_PC","start_follow_up_SK_ERYTHEMANODOSUM_AESI_HOSP_DISP","start_follow_up_SK_ERYTHEMANODOSUM_AESI_HOSP_SPEC_DISP", "cohort_entry_date_SK_ERYTHEMANODOSUM_AESI_PC", "cohort_entry_date_SK_ERYTHEMANODOSUM_AESI_HOSP_DISP")
