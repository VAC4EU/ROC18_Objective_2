...
listdatasetsRData <- c(paste0(immdis,"_narrow"),"O_FLARE_AESI_narrow","DP_GLATIRAMER", "DP_TERIFLUNOMIDE", "DP_OTHERIMMUNOSUPPRESSANTS", "DP_MONOANTIBODIES", "DP_CLADRIBINE", "DP_S1PMODULATORS", "DP_MITOXANTRONE","DP_INTERFERONBETA1A1B")
