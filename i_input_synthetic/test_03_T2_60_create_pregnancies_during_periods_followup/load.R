...
listdatasetsRData <- c("D3_pregnancy_final")

listdatasets <- c("D3_followup_periods_in_cohort_E_GRAVES_AESI",listdatasetsRData)
...
listdates[["D3_pregnancy_final"]] <- c("pregnancy_start_date", "pregnancy_end_date")
