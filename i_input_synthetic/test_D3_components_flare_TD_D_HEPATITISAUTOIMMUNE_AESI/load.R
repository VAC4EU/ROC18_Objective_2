...
listdatasetsRData <- c(paste0(immdis,"_narrow"), "O_FLARE_AESI_narrow", "DP_CORTICOSTAIH","DP_MYCOPHENOLICACID","DP_TACROLIMAIH","DP_EVEROLIMUSAIH","DP_TNFAIH","DP_RITUXIMABAIH","DP_CICLOSPORINAIH","DP_DILIMOST","D_ALCOHOLICLIVER_COV_narrow","I_HEPATITIS_COV_narrow")
