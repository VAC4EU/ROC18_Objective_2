...
listdatasetsRData <- c(paste0(immdis,"_narrow"),"O_FLARE_AESI_narrow", "DP_DMARD","DP_CORTICOST","DP_NSAIDRA")


for (dis in c("SO_SCLERITIS_AESI", "N_TUNNELCARPAL_AESI", "M_CERVICALMYELOPATHY_AESI", "Im_FELTYSYNDROME_AESI", "Im_RHEUMATOIDVASCULITIS_AESI", "R_PLEURITIS_AESI", "C_PERICARDITISRA_AESI", "Im_RHEUMATOIDNODULE_AESI")){
  listdatasetsRData <- c(listdatasetsRData, paste0(dis,"_narrow"))
}
