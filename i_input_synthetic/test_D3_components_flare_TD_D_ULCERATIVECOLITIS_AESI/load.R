...
listdatasetsRData <- c(paste0(immdis,"_narrow"), "O_FLARE_AESI_narrow", "TP_BLOODTRANSFUSIONUC_AESI", "TP_COLECTOMY_AESI", "TP_PROCTOCOLECTOMY_AESI", "TP_RESTRPROCTOCOLECUC_AESI", "DP_AMINOSALICYLATES", "DP_BUDESONIDE", "DP_CORTICOSTUC", "DP_AZATHIOPRINE", "DP_USTEKINUMABUC", "DP_VEDOLIZUMAB", "DP_TOFACITINIB", "DP_TACROLIMUC", "D_RECTALBLEED_AESI_narrow", "B_ANAEMIACOLITIS_AESI_narrow"    )
