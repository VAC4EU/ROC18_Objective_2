...
listdatasets <- c("D3_followup_periods_in_cohort_E_GRAVES_AESI", "D3_TD_pregnancy_during_followup_E_GRAVES_AESI",listdatasetsRData)
...
listdates[["D3_followup_periods_in_cohort_E_GRAVES_AESI"]] <- c("cohort_entry_date_E_GRAVES_AESI", "start_follow_up_E_GRAVES_AESI", "start_period_E_GRAVES_AESI_d", "end_period_E_GRAVES_AESI_d")

listdates[["D3_TD_pregnancy_during_followup_E_GRAVES_AESI"]] <- c("start_record_d", "end_record_d")
