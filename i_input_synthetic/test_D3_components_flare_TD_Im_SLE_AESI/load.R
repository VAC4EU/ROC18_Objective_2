...
listdatasetsRData <- c(paste0(immdis,"_narrow"),"O_FLARE_AESI_narrow","DP_DMARDSLE", "DP_CORTICOSTSLE", "DP_IMMUNOSUPRESSANTSLE", "DP_ANIFROLUMAB", "DP_BELIMUMAB", "DP_RITUXIMAB", "DP_CICLOSPORIN", "DP_VOCLOSPORIN", "DP_CYCLOPHOSPHAMIDE", "DP_NSAIDSLE"   )
