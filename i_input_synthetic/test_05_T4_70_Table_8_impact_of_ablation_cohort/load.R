...
listdates[["D3_cohort_E_GRAVES_AESI"]] <- c("cohort_entry_date_E_GRAVES_AESI","cohort_entry_date_E_GRAVES_AESI_PC","cohort_entry_date_E_GRAVES_AESI_HOSP_DISP","cohort_entry_date_E_GRAVES_AESI_HOSP_SPEC_DISP",	"study_exit_date", "start_follow_up_E_GRAVES_AESI","start_follow_up_E_GRAVES_AESI_PC","start_follow_up_E_GRAVES_AESI_HOSP_DISP","start_follow_up_E_GRAVES_AESI_HOSP_SPEC_DISP")
