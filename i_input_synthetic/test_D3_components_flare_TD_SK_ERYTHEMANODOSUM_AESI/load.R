...
listdatasetsRData <- c(paste0(immdis,"_narrow"), "O_FLARE_AESI_narrow", "Sk_PANNICULITIS_AESI_narrow", "TP_DEBRIDEMENTEN_AESI", "DP_NSAIDEN", "DP_COLCHICINE", "DP_CORTICOSTEN", "DP_DAPSONE", "DP_TETRACYCLINES", "DP_TNFEN", "DP_THALIDOMIDE")
