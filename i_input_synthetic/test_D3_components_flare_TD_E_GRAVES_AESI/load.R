...
listdatasetsRData <- c(paste0(immdis,"_narrow"),"O_FLARE_AESI_narrow", "DP_ANTITHYROID", "E_THYROIDSTORM_AESI_narrow", "TP_THYROIDECTOMY_AESI", "TP_RADIOIODINEABLA_AESI")

listdatasets <- c("D3_cohort_E_GRAVES_AESI",listdatasetsRData)
...
listdates[["D3_cohort_E_GRAVES_AESI"]] <- c("cohort_entry_date_E_GRAVES_AESI",	"study_exit_date", "start_follow_up_E_GRAVES_AESI","start_follow_up_E_GRAVES_AESI_PC","start_follow_up_E_GRAVES_AESI_HOSP_DISP","start_follow_up_E_GRAVES_AESI_HOSP_SPEC_DISP")
