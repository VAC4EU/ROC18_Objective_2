...
listdatasets <- c("D3_cohort_Im_HASHIMOTO_AESI_sensitivity")
...
listdates[["D3_cohort_Im_HASHIMOTO_AESI_sensitivity"]] <- c("cohort_entry_date_Im_HASHIMOTO_AESI_sensitivity", "study_entry_date",	"study_exit_date", "start_follow_up_Im_HASHIMOTO_AESI_sensitivity","start_follow_up_Im_HASHIMOTO_AESI_sensitivity_PC","start_follow_up_Im_HASHIMOTO_AESI_sensitivity_HOSP_DISP","start_follow_up_Im_HASHIMOTO_AESI_sensitivity_HOSP_SPEC_DISP", "cohort_entry_date_Im_HASHIMOTO_AESI_sensitivity_PC", "cohort_entry_date_Im_HASHIMOTO_AESI_sensitivity_HOSP_DISP")
