...
listdatasets <- c("D3_followup_periods_in_cohort")
...
listdates[["D3_followup_periods_in_cohort"]] <- c("cohort_entry_date_E_GRAVES_AESI", "study_exit_date", "start_follow_up_E_GRAVES_AESI",
                                                                "start_period_E_GRAVES_AESI_d", "end_period_E_GRAVES_AESI_d")
